...
void Delta(int Alfa[], int tamAlfa, int Beta[], int tamBeta);
...
{
    int *Gamma;
    int tamGama = tamAlfa + tamBeta;
    int iGamma = 0;

    Gamma = new int [tamGama]; /// buffer // pedir el espacio
